package net.mcreator.dashscampmod;
...
@Mod("dashs_camp_mod")
public class DashsCampModMod {
	public static final Logger LOGGER = LogManager.getLogger(DashsCampModMod.class);
	public static final String MODID = "dashs_camp_mod";

	public DashsCampModMod(IEventBus modEventBus) {
